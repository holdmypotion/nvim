return {
    {
        ...
        config = function()
            ...
            map("n", "<leader>gd", "<cmd>Gitsign diffthis<cr>", "Git Diff this file")
            map("n", "<leader>gb", "<cmd>Gitsign blame<cr>", "Show the blame")
            require('gitsigns').setup {
                ...
                on_attach = function(bufnr)
                    ...
                    map('n', '<leader>gq', gitsigns.setqflist, "Set quickfix list")
